...
export default function Display({ expression, result, error }: DisplayProps) {
  return (
    <div className="bg-zinc-950 border border-purple-900 rounded p-4 mb-4 min-h-[90px] arc-blue">
      ...
      {error ? (
        ...
        <div className="text-yellow-400 text-right text-3xl font-bold mt-1 tracking-widest">
          {result || '0'}
        </div>
      )}
    </div>
